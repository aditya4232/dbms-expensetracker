...
if (isset($_POST['add'])) {
    ...
    $income = "INSERT INTO income (user_id, incomeamount,incomedate,incomedescription) VALUES ('$userid', '$incomeamount','$incomedate','$incomedescription')";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE income SET incomeamount='$incomeamount', incomedate='$incomedate', incomedescription='$incomedescription' WHERE user_id='$userid' AND income_id='$id'";
...
if (isset($_GET['edit'])) {
    ...
    if (mysqli_num_rows($record) == 1) {
        ...
        $incomeamount = $n['incomeamount'];
        $incomedate = $n['incomedate'];
        $incomedescription = $n['incomedescription'];
    } else {
...
<head>
    ...
    <title>Expense Manager - Income </title>
...
<body>
  ...
  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2zm2 .5v2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5h-7a.5.5 0 0 0-.5.5m0 4v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5M4.5 9a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zM4 12.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5M7.5 6a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zM7 9.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5m.5 2.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zM10 6.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5m.5 2.5a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5z"/>
        ...
        <a href="income.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="dollar-sign"></span> Income</a>
  ...
  <path d="M12.136.326A1.5 1.5 0 0 1 14 1.78V3h.5A1.5 1.5 0 0 1 16 4.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 13.5v-9a1.5 1.5 0 0 1 1.432-1.499zM5.562 3H13V1.78a.5.5 0 0 0-.621-.484zM1.5 4a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5z"/>
    ...
    <h3 class="try">Income Manager</h3>
</div>
...
<div class="form-group row">
    <label for="incomedescription" class="col-sm-6 col-form-label"><b>Description</b></label>
    <div class="col-md-6">
        <textarea class="form-control col-sm-12" id="incomedescription" name="incomedescription" rows="3"></textarea>
    </div>
</div>
...
if (isset($_POST['add'])) {
    $incomeamount = $_POST['incomeamount'];
    $incomedate = $_POST['incomedate'];
    $incomedescription = $_POST['incomedescription'];// Add this line to fetch comment

    $income = "INSERT INTO income (user_id, incomeamount,incomedate,incomedescription) VALUES ('$userid', '$incomeamount','$incomedate','$incomedescription')"; // Include expensecomment in the INSERT query
    
}
$inc_fetched = mysqli_query($con, "SELECT * FROM income WHERE user_id = '$userid' ORDER BY incomedate");
?>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <br>
                        <h4 class="mt-4">Income History</h4>
    ...
    <tr class="text-center">
        ...
        <th>Amount</th>
        <th>Description</th> <!-- New column for comments -->
...
<?php
                        ...
                        while ($row = mysqli_fetch_array($inc_fetched)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo $row['incomedate']; ?></td>
                                <td class="text-center"><?php echo $row['incomeamount']; ?></td>
                                <td class="text-center"><?php echo $row['incomedescription']; ?></td> <!-- Display comment -->
                                <td class="text-center">
                                    <a href="income.php?edit=<?php echo $row['income_id']; ?>" class="btn btn-primary btn-sm"
                                        style="border-radius:0%;">Edit</a>
                                </td>
                                <td class="text-center">
                                    <a href="income.php?delete=<?php echo $row['income_id']; ?>" class="btn btn-danger btn-sm"
